...
const TodoListItem = (props) => {
    const {id, label, important,
    done, } = props;

    const {
        toogleProperty,
        deleteItem, } = useContext(todoContext);

    let listStyle = "TodoListItem";
    ...
    return (
        <div className={listStyle}>
            <span onClick={() => toogleProperty("done", id)}>
                {label}
            </span>
            <div>
                <button 
                ...
                onClick={() => toogleProperty("important", id)}
                >
